...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'web_url' : forms.TextInput(attrs={'class':'form-control bg-dark text-light','placeholder':'www.example.com'}),
...
class SignUpForm(UserCreationForm):
    ...
    last_name = forms.CharField(max_length = 100,widget=forms.TextInput(attrs={'class':'form-control bg-dark text-light','placeholder':'Enter Last Name'}))
...
class EditProfileForm(UserChangeForm):
    ...
    last_name = forms.CharField(max_length = 100,widget=forms.TextInput(attrs={'class':'form-control bg-dark text-light','placeholder':'Mikaelson'}))
